...
class ReasonId(str, Enum):
    ...
    # Proposal / governance failures
    AC_V3_PROPOSAL_INVALID = "AC_V3_PROPOSAL_INVALID"
    AC_V3_PROPOSAL_TIMESTAMP_INVALID = "AC_V3_PROPOSAL_TIMESTAMP_INVALID"
    AC_V3_PROPOSAL_HASH_INVALID = "AC_V3_PROPOSAL_HASH_INVALID"
